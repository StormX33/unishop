	...
	<div class="remodal remodal-is-initialized remodal-is-opened">
		...
		<header class="popup_header">
			...
			<div class="popup__header_img-wrap">
            	<img src="{$THEME}images/icons/popup/{echo $imgname ? $imgname : 'for_popup1'}.png" />
            </div>
			...
			<form action="{site_url('callbacks')}" method="post" data-form-ajax="callback_modal" class="feedback_form popup__feedback_form"> 
				...
				<div class="feedback__button">
					<div class="submit__btn_accent">
						{if !$success}
							<input class="feedback-submit" type="submit" value="{echo $buttontext ? $buttontext : tlang('Call back')}">
						{else:}
