...
<div class="main-content">
	<div class="detail__main_col">
        ...
        <div class="product__right__collumn">
            ...
            <div class="buy__click">
            	<form method="post" class="buy__click_form" action="{echo $CI->load->module('Buy_one_click')->buy ()}">
	...
	<div class="product__buy">
		<div class="product__buy_header"><h3 class="product__buy_title">Купить {echo $model->getName()}</h3></div>
