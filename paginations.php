...
/* paginator wrapper */
$paginationConfig['full_tag_open'] = '<ul class="page__pagination_list">';
$paginationConfig['full_tag_close'] = '</ul>';

/* First page */
$paginationConfig['first_tag_open'] = '<li class="paginator__item first">';
$paginationConfig['first_link'] = '1';
$paginationConfig['first_tag_close'] = '</li><li class="paginator__item">...</li>';
...
/* Page number active */
$paginationConfig['cur_tag_open'] = '<li class="page__pagination_item active">';
$paginationConfig['cur_tag_close'] = '</li>';

/* Next page */
$paginationConfig['next_tag_open'] = '<li class="page__pagination_item pagination__item_next">';
$paginationConfig['next_link'] = '<div class="pagination__mark"></div>';
$paginationConfig['next_tag_close'] = '</li>';

/* Last page */
$paginationConfig['last_tag_open'] = '<li class="page__pagination_item">...</li><li class="page__pagination_item paginator__item--last">';
