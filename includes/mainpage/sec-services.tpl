                ...
                <div class="services__description_inner"> 
                    <ul class="services__description_list">
                        ...
                        <a href="{site_url('uslugi/proektirovanie-i-podbor-oborudovaniia')}">
                            <div class="description__image_wrap"><img src="{$THEME}images/services/personIcon1.png" alt="personIcon1" class="description__image description__image_main"></div>
                        ...
                        <li class="services__description_item">
                         <a href="{site_url('uslugi/komplektatsiia-obektov-pod-kliuch')}">
                            <div class="description__image_wrap"><img src="{$THEME}images/services/personIcon2.png" alt="personIcon2" class="description__image description__image_main"></div>
                            <div class="description__item_title">Подбор и комплектация</div>
                            </a>
                        </li>
                        <li class="services__description_item">
                        <a href="{site_url('uslugi/montazh-oborudovaniia')}">
                            <div class="description__image_wrap"><img src="{$THEME}images/services/personIcon3.png" alt="personIcon3" class="description__image description__image_main"></div>
                            <div class="description__item_title">Шеф-монтаж            </div>
                            </a>
                        </li>
                        <li class="services__description_item">
                        <a href="{site_url('uslugi/servisnoe-obsluzhivanie')}">
                            <div class="description__image_wrap"><img src="{$THEME}images/services/personIcon4.png" alt="personIcon4" class="description__image description__image_main"></div>
            ...
            <div class="services__description_wrap">
                <div class="services__description_inner"> 
                    <ul class="services__description_list">
                        <li class="services__description_item">
                        <a href="{site_url('uslugi/komplektatsiia-obektov-pod-kliuch')}">
                            <div class="description__image_wrap"><img src="{$THEME}images/services/personIcon2.png" alt="professionalsIcon1" class="description__image description__image_main"></div>
                            <div class="description__item_title">Полная комплектация объекта</div>
                            </a>
                        </li>
                        <li class="services__description_item">
                        <a href="{site_url('sotrudnichestvo')}">
                            <div class="description__image_wrap"><img src="{$THEME}images/services/professionalsIcon2.png" alt="professionalsIcon2" class="description__image description__image_main"></div>
                            <div class="description__item_title">Индивидуальные цены</div>
                            </a>
                        </li>
                        <li class="services__description_item">
                        <a href="{site_url('callbacks')}?subj=2" data-modal="callbacks_modal"s>
                            <div class="description__image_wrap"><img src="{$THEME}images/services/professionalsIcon3.png" alt="professionalsIcon3" class="description__image description__image_main"></div>
                            <div class="description__item_title">Информационная и техническая поддержка</div>
                            </a>
                        </li>
                        <li class="services__description_item">
                        <a href="{shop_url('categories')}">
                            <div class="description__image_wrap"><img src="{$THEME}images/services/professionalsIcon4.png" alt="professionalsIcon4" class="description__image description__image_main"></div>
                ...
                <div class="services__description_inner"> 
                    <ul class="services__description_list">
                        <li class="services__description_item">
                            ...
                            <div class="description__image_wrap"><img src="{$THEME}images/services/dealersIcon1.png" alt="dealersIcon1" class="description__image description__image_main"></div>
                            <div class="description__item_title">Cтабильный и высокодоходный бизнес</div>
                            </a>
                        </li>
                        <li class="services__description_item">
                        <a href="{site_url('sotrudnichestvo')}">
                            <div class="description__image_wrap"><img src="{$THEME}images/services/dealersIcon2.png" alt="dealersIcon2" class="description__image description__image_main"></div>
                            <div class="description__item_title">Гибкие условия сотрудничества</div>
                            </a>
                        </li>
                        <li class="services__description_item">
                        <a href="{site_url('oplata-i-dostavka')}">
                            <div class="description__image_wrap"><img src="{$THEME}images/services/dealersIcon3.png" alt="dealersIcon3" class="description__image description__image_main"></div>
                        ...
                        <li class="services__description_item">
                         <a href="{site_url('callbacks')}?subj=4" data-modal="callbacks_modal" rel="nofollow">
                            <div class="description__image_wrap"><img src="{$THEME}images/services/dealersIcon4.png" alt="dealersIcon4" class="description__image description__image_main"></div>
